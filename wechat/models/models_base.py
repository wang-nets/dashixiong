...
class Provinces(MODEL_BASE):
    ...
    university = relationship("Universities", cascade="all, delete-orphan", passive_deletes=True)
...
class Universities(MODEL_BASE):
    ...
    enable = Column(Boolean, nullable=False)
    major = relationship("Colleges", cascade="all, delete-orphan", passive_deletes=True)
...
class Colleges(MODEL_BASE):
    ...
    enable = Column(Boolean, nullable=False)
    major = relationship("Majors", cascade="all, delete-orphan", passive_deletes=True)
...
class Majors(MODEL_BASE):
    ...
    enable = Column(Boolean, nullable=False)
    student = relationship("Students", cascade="all, delete-orphan", passive_deletes=True)
