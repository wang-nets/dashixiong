...
class StudentPost(Resource):
    ...
    def post(self):
        ...
        args_dict['student_id'] = args.get('college_id', None)
        ...
        args_dict['picture'] = args.get('have_picture', True)
...
class StudentGet(Resource):
    ...
    def get(self, major_id):
        LOG.info("Call url:/api/v1/student, method:GET, major_id:%s" % major_id)
        try:
            student = StudentController()
            ret_dict = student.get_student_info_by_major_id(major_id=major_id)
...
class StudentPutDelete(Resource):
    ...
    def put(self, major_id, student_id):
        ...
        try:
            ...
            args_dict['create_user'] = args.get('create_user', None)
